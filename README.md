...
From the assessment, there has to be a schema for an invoice with invoice details and arrays of items and sundries. I have defined a schema for this. For the auto increment, I'm using the mongoose-sequence plugin.
